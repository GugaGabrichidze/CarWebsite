                    ...
                    <div className="car-specs">
                        <div className="specs-row">
                            <span className="spec-item">
                                <i className="spec-icon"><img src="/src/photos/wheel.svg" /></i>
                                {car.right_wheel ? "მარჯვენა" : "მარცხენა"} საჭე
                            </span>
                            <span className="spec-item">
                                <i className="spec-icon"><img src="/src/photos/gear.svg" /></i>
                                {transmissionTypes[car.gear_type_id] || "გადაცემათა კოლოფი"}
                            </span>
                        </div>
                        <div className="specs-row">
                            <span className="spec-item">
                                <i className="spec-icon"><img src="/src/photos/engine.svg" /></i>
                                {engineVolume} {fuelTypes[car.fuel_type_id] || ""}
                            </span>
                            <span className="spec-item">
                                <i className="spec-icon"><img src="/src/photos/km_run.svg" /></i>
